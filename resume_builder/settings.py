...
INSTALLED_APPS = [
    ...
    'cltemplateapp.apps.CltemplateappConfig',
    'coverletterapp.apps.CoverletterappConfig',
    ]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,"templates"), os.path.join(BASE_DIR, 'media/templates/html')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
